...
SAML.prototype.generateAuthorizeRequest = function (req, options, callback) {
  ...
  .then(function(){
    ...
    var stringRequest = xmlbuilder.create(request, self.options.requestXmlbuilderOptions).end();
      ...
      .then(function(certs) {
        var hasValidQuerySignature = certs.some(function (cert) {
          return validateSignatureForRedirect(
            urlString, container.Signature, container.SigAlg, self.certToPEM(cert)
          );
        });
